...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicGFsYWFzaHMiLCJhIjoiY2t3dXJpczU1MXQyNjJ2cG01MWx4OHQ5aSJ9.bsDz7KpX6W-g_PqmZruDwg';
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://127.0.0.1:3000/api/v1/users/updateMyPassowrd' : 'http://127.0.0.1:3000/api/v1/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
          ...
          case 8:
            ...
            (0, _alerts.default)('error', 'Invalid entry(s)');
...
var stripe = Stripe('pk_test_51K4A1LSIAjewpMd4Bt5iAJLYl71NVsUIgRQvOTklgdkbVuPGKKy8jndjp0TQR8Fz8Cr5rxMh1LNWOyQAvbBrMi2800gGfZKcfp');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // 2. create checout form + chanre credit card
